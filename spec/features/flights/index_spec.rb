...
RSpec.describe 'Flights Index Page', type: :feature do
  describe "User Story 1" do
    it "displays all Flights, and their airline" do
      ...
      fly1 = air1.flight.create!(number: "177", date: "06/16/22", arrival_city: "Boston", departure_city: "Denver")
      fly2 = air1.flight.create!(number: "208", date: "06/16/22", arrival_city: "Geneva", departure_city: "Houston")

      air2 = Airline.create!(name: "Denta")
      fly3 = air2.flight.create!(number: "444", date: "06/16/22", arrival_city: "Langston", departure_city: "Tampa")
      fly4 = air2.flight.create!(number: "101", date: "06/16/22", arrival_city: "Tampa", departure_city: "Santa Fe")
